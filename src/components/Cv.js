...
export default function Cv(){
  return (
    <div className='p-5 w-full'>
      <a href="#" className="flex flex-col items-center bg-teal-200 rounded-lg shadow-md md:flex-col md:max-w-md hover:bg-teal-300 dark:border-gray-700 dark:hover:bg-teal-100">
