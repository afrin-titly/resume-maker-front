...
export default function Cv(){
  return (
    <div className='p-5 w-full'>
      <Link to="/user/1" className="flex flex-col items-center bg-amber-200 rounded-lg shadow-md md:flex-col md:max-w-md hover:bg-amber-300">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <p className="mb-3 font-normal text-gray-700">Hi! I am john doe. Software engineer at google.</p>
        </div>
      </Link>
    </div>
  )
