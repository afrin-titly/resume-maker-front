...
export default function Cv(){
  return (
    <div className='p-5 w-full'>
      <Link to="/user/1" className="flex flex-col items-center bg-amber-200 rounded-lg shadow-md md:flex-col md:max-w-md hover:bg-amber-300 dark:border-gray-700 dark:hover:bg-teal-100">
