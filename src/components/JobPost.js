  ...
  return (
    <div className="max-w-sm bg-teal-200 rounded-lg border border-gray-200 shadow-md dark:hover:bg-teal-400">
      ...
      <div className="p-5">
        ...
        <Link to="/jobs/1" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-orange-800 rounded-lg hover:bg-orange-800 focus:outline-none focus:ring-blue-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
          Read more
