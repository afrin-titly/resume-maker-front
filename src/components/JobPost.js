...
const JobPost = () => {
  return (
    <div className="max-w-sm bg-emerald-100 rounded-lg border border-gray-200 shadow-md dark:hover:bg-emerald-300">
      <a href="#">
      ...
      <div className="p-5">
        ...
        <a href="#" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-emerald-800 rounded-lg hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
          Read more
